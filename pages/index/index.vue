<template>
  ...
  <section class="p-3">
    ...
    <div class="flex justify-start mb-3 mt-3"
      v-if="resDashboardJobs?.jobs_mission?.length == 0 || !resDashboardJobs?.jobs_mission">
      <a-empty>
    ...
    <div class="flex justify-start"
      v-if="resDashboardJobs?.jobs_mission_follow?.length == 0 || !resDashboardJobs?.jobs_mission_follow">
      <a-empty>
        <template #description>
          <span>
