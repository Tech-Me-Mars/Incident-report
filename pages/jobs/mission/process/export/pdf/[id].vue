<template>
  ...
  <section class="p-3">
    ...
    <!-- <NuxtLink :to="`/jobs/mission/process/${route.params.id}`"> -->
...
const redirectToJobPage = () => {
  ...
  if (jobid && jobid!="undefined") {
    router.push(`/jobs/mission/process/${route.params.id}?jobid=${jobid}`);
  } else {
    router.push(`/jobs/mission/process/${route.params.id}`);
  }
};
