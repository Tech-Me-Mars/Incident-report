...
export function saveJobprocess(payload) {
  const url = `/api/v1/jobs_process`;
  return request("post", url, payload, true);
}

export function updateUserCreate(payload,id) {
  const url = `/api/v1/jobs_process/update_create/${id}`;
