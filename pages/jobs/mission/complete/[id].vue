                ...
                <template #body>
                    <div class="px-2">
                        <div class="flex justify-between text-blue-100 mb-2 ">
                            ...
                            <span class="ml-auto font-light text-xs">{{ resJobProcessDetail?.jobs?.plan_job_employee_fullname
                                }}</span>
                        </div>
                ...
                <span class="ml-auto font-light text-xs">{{ item?.responsible_employee_fullname }}</span>
                        ...
                        <div class="flex flex-warp">
                            <p class="font-medium text-md">รายละเอียดงาน: <span class="ml-auto font-light text-sm">{{
                                resJobProcessDetail?.jobs_process?.text_jobs_process_detail }}</span></p>
                        </div>
                    </div>
                    <hr class="my-1">
