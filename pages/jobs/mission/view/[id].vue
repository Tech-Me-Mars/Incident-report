        ...
        <div class="card p-3 mb-3">
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <div class="mb-2">
                    ...
                    <TmmInputCalendar v-model="date_end" disabled />
                </div>
            </div>
            <div class="grid grid-cols-1 mb-2">
                <div class="mb-2">
                    <TmmTypographyLabelForm label="รายละเอียดงาน" />
                    <TmmInputTextarea :rows="2" v-model="text_process" disabled />
                </div>
            ...
            <div class="flex flex-col gap-2 mb-2">
                ...
                <a-upload v-model:file-list="jobs_process_image" accept="image/*" @preview="handlePreview"
                    list-type="picture" multiple name="file" :headers="headers" :custom-request="customRequestAddFile"
                    @remove="handleRemove" disabled>
                    <a-button>
            ...
            <div class="grid grid-cols-1 mb-2">
                <div class="mb-2">
                    ...
                    <TmmInputDropDown v-model="status_approve" placeholder="สถานะดำเนินงาน" disabled className=""
    ...
    try {
        const payload = {
            ...
            jobs_process: fields.value.map((item) => ({
                ...
                text_process: item.value.text_process,
