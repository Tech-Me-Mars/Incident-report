<template>
    <a-config-provider :theme="{
        ...
        <a-button :type="type" :htmlType="htmlType" :ghost="outlined" :loading="loading" :class="`w-[2.5rem] h-[2.5rem] text-center !flex items-center justify-center rounded-xl${className}`"
