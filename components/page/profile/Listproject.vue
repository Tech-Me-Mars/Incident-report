<template>
  ...
  <div class="card p-5 mb-2" v-for="(item, index) in resMyReports" :key="index">
    ...
    <div class="flex w-full items-center gap-3 mb-2">
      ...
      <div class="flex flex-col justify-center items-center">
        ...
        <span v-if="item?.news_like_sum && item?.news_like_sum!=0" class="text-xs">({{ item?.news_like_sum}})</span>
      </div>
      ...
      <div class="flex flex-col">
        ...
        <!-- </NuxtLink> -->
        <span class="text-sm ">ความเสียหาย : <span>{{formatCurrency(item?.property_price)}}</span></span>
  ...
  <div class="flex justify-center mb-5">
    <a-pagination v-model:current="currentPageMyReports" @change="pagiChangeMyReports" :total="totalRowMyReports"
      class="border-gray-300 p-1 border rounded-xl bg-white" v-model:page-size="rowPerPageMyReports" />
  </div>
